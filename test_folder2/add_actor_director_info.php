	    	...
	    	<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<!-- Input form -->
					<form action="<?php $_PHP_SELF?>" method="GET">
						...
						<br><br>
						Date of Birth*: <input class="form-control" type="date" name="dateofbirth" placeholder="07/01/1996" required/>
						<br>
						Date of Death: <input type="date" class="form-control" name="dateofdeath" placeholder="07/01/2017"/>
						<br>
						...
						<?php
							...
							if(isset($_GET['title']) && isset($_GET['last_name']) && isset($_GET['first_name']) && isset($_GET['gender']) && isset($_GET['dateofbirth']) ){
							...
							$birth_date = $_GET['dateofbirth'];
							$birth_date = date("Y-m-d", strtotime($birth_date));
							if(!empty($_GET["dateofdeath"])){
								$death_date = $_GET['dateofdeath'];
