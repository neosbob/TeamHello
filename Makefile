...
reply_test: 
	...
	g++ -std=c++0x -isystem ${GTEST_DIR}/include -pthread reply_test.cc reply.cc ${GTEST_DIR}/src/gtest_main.cc libgtest.a -o reply_test -lboost_system
...
webserver: webserver.h webserver.cc webserver_main.cc config_parser.h config_parser.cc request_handle.h reply.o request_handle.o
	g++ webserver.h webserver.cc webserver_main.cc config_parser.cc reply.o request_handle.o -I /usr/local/Cellar/boost/1.54.0/include -std=c++0x -lboost_system -o webserver

reply.o: reply.cc reply.h
	g++ -c -std=c++0x reply.cc -lboost_system

request_handle.o: request_handle.cc request_handle.h reply.h
	g++ -c -std=c++0x request_handle.cc  
