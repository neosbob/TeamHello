...
default:  config_parser request_handler.o echo_handler.o config_testing_handler.o configResetHandler.o file_handler.o not_found_handler.o status_handler.o request.o response.o mime_types.o session.o cloud_file_handler.o webserver
...
config_reset_handler.o: configResetHandler.cc configResetHandler.h request_handler.h mime_types.h mime_types.cc response.cc response.h request.cc request.h
	g++ -c -std=c++11 configResetHandler.cc -lboost_system
...
session.o: session.cc session.h request_handler.h echo_handler.h file_handler.h configTestingHandler.h configResetHandler.h status_handler.h response.cc response.h request.cc request.h webserver.h
...
webserver: webserver.h webserver.cc webserver_main.cc config_parser.h config_parser.cc session.h request_handler.o session.o mime_types.o file_handler.o configTestingHandler.o configResetHandler.o echo_handler.o not_found_handler.o status_handler.o request.o response.o http_client.o proxy_handler.o cloud_file_handler.o
	g++ webserver.h webserver.cc webserver_main.cc config_parser.cc request_handler.o session.o mime_types.o file_handler.o configTestingHandler.o configResetHandler.o echo_handler.o not_found_handler.o status_handler.o request.o response.o http_client.o proxy_handler.o cloud_file_handler.o -I cpp-markdown/*.cpp -I /usr/local/Cellar/boost/1.54.0/include -std=c++11 -static-libgcc -static-libstdc++ -pthread -Wl,-Bstatic -lboost_thread -lboost_system -lboost_regex -o webserver
